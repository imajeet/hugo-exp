...
exports.config = {
   ...
   */
  license_key: '97f1dba447725fe387aca945d8caabfaa04fad3f',
  /**
  ...
  logging: {
     ...
     * @env NEW_RELIC_LOG
     */
    filepath: require('path').join(process.cwd(), 'newrelic_agent.log'), // eslint-disable-line
    /**
  ...
  rules: {
     ...
     */
    ignore: [
      '^\/socket\.io\/.*\/xhr-polling/', // eslint-disable-line
    ]
  },
  /**
